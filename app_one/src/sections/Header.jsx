...
const NavLink=({title})=>(
  <LinkScroll className=" base-bold text-p4 uppercase transition-colors
  ...
  return (
    ...
    <div className="container flex h-14 items-center max-lg:px-5">
     ...
     <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0 ',
         ...
         isOpen ? 'max-lg:opacity-100 max-lg:pointer-events-auto'
        ...
        <ul className="flex max-lg:block max-lg:px-12 ">
          ...
          <li className="nav-logo">
            <LinkScroll to="hero" offset={-100} spy smooth className={
              clsx('max-lg:hidden transition-transform duration-500 cursor-pointer')}>
    ...
    <button className="lg:hidden  z-50 w-10 h-10 border-2 border-s4/25 
    rounded-full flex justify-center items-center " onClick={()=> setIsOpen(
      (prevState)=> !prevState)}>
...
//className="container flex h-14 items-center max-lg:px-5
